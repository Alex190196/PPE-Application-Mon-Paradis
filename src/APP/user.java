...
public class user extends JFrame {
	...
	public user() {
		...
		JLabel lblGestionUtilisateur = new JLabel("Gestion Utilisateurs");
		lblGestionUtilisateur.setFont(new Font("Tahoma", Font.BOLD, 20));
		lblGestionUtilisateur.setBounds(339, 13, 215, 34);
		...
		label.setBounds(30, 121, 56, 16);
		contentPane.add(label);
		
		JLabel lblnom = new JLabel("Nom");
		lblnom.setFont(new Font("Tahoma", Font.BOLD, 13));
		lblnom.setBounds(30, 132, 56, 16);
		...
		lblusername.setBounds(32, 238, 129, 16);
		...
		lblPassword.setBounds(33, 408, 76, 16);
...
//				userStmt.setString(1, txtSearch.getText());
		...
		lblRecherche.setBounds(469, 56, 97, 16);
		...
		lblCritère.setBounds(668, 56, 56, 16);
		contentPane.add(lblCritère);
		
		JLabel lblNewLabel = new JLabel("New label");
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\User\\eclipse-workspace\\APP Bureau\\img\\55.jpg"));
