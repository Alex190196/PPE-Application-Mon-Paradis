...
public class client extends JFrame {
	...
	//}
		...
		JLabel lblGestionclient = new JLabel("Gestion de Clients");
		lblGestionclient.setForeground(new Color(0, 0, 0));
		lblGestionclient.setFont(new Font("Tahoma", Font.BOLD, 20));
		lblGestionclient.setBounds(402, 13, 240, 31);
		...
		lblsexe.setBackground(new Color(0, 0, 0));
		...
		btnenregistrer.setBounds(126, 612, 111, 33);
	...
	////////////==================validation boutton supprimer====================///////////////
		...
		btnsupprimer.setBounds(814, 612, 111, 33);
		...
		lblid_client.setForeground(new Color(0, 0, 0));
		...
		separator.setBounds(12, 42, 1028, 2);
		contentPane.add(separator);
		
		JLabel lblRecherche = new JLabel("Recherche");
		lblRecherche.setForeground(Color.WHITE);
		lblRecherche.setFont(new Font("Tahoma", Font.BOLD, 13));
		lblRecherche.setBounds(449, 117, 76, 16);
		contentPane.add(lblRecherche);
		
		JLabel lblNewLabel_1 = new JLabel("Crit\u00E8re");
		lblNewLabel_1.setForeground(Color.WHITE);
		lblNewLabel_1.setFont(new Font("Tahoma", Font.BOLD, 13));
		lblNewLabel_1.setBounds(849, 117, 56, 16);
		contentPane.add(lblNewLabel_1);
		
		JSeparator separator_1 = new JSeparator();
		separator_1.setBounds(27, 597, 1013, 2);
	...
	//////////////////////////////////validation of combo/////////////////////////////////////////////	
		...
		btnmodifier.setBounds(494, 612, 104, 33);
		...
		txtSearch.setBounds(428, 133, 116, 22);
	...
	//////////////////////////////////////////////////////////////////////////	
		...
		comboBoxCriteria.setBounds(810, 133, 133, 22);
		contentPane.add(comboBoxCriteria);
		
		/////////////////////////////////////////////
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(319, 168, 754, 374);
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					...
					if(rs.next()) {
						...
						comboBoxGender.setSelectedItem(data5);
		...
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\User\\eclipse-workspace\\APP Bureau\\img\\103.jpg"));
		lblNewLabel.setBounds(0, 0, 1073, 658);
